...
# 0. pre-process
EVAL_SCRIPT='/home/getalp/zanonbom/attention_study/evaluation/ZRC_corpora/mboshi/5k/phonemic/eval2.py'
...
for i in $(cat $LABELS_LIST); do 
    ...
    cat $i | awk '{print $3, $1/10^7, $2/10^7}' > ./$FA_DIR_NAME/$bare_name.txt; 
