...
pushd evaluation/hungarian_ZRC_eval/
# RUN NAME TO MODIFY
RUN_NAME="5k_eval"
mkdir -p $RUN_NAME
pushd ./$RUN_NAME
...
# 0. pre-process
EVAL_SCRIPT='/home/getalp/zanonbom/evaluation/ZRC_corpora/hungarian/eval2.py'
...
python3 /home/getalp/zanonbom/evaluation/ZRC_corpora/hungarian/eval/process_data.py \
...
CORPUS='hungarian' python $EVAL_SCRIPT -v $OUT_DIR_NAME.word.fa.classes  $OUT_DIR_NAME.eval/ -m boundary #token/type
